...
vim.keymap.set(
	...
	{ noremap = true, silent = true, desc = "Close buffers on the left side" }
)
...
vim.keymap.set(
	...
	{ noremap = true, silent = true, desc = "Close buffers on the right side" }
)

vim.keymap.set("n", "<space>dh", function()
	local file_path = vim.fn.expand("%")
	vim.cmd("DiffviewFileHistory" .. file_path)
end, { noremap = true, silent = true, desc = "Diff current file git history" })

vim.keymap.set("n", "<space>dc", ":DiffviewClose<cr>", { noremap = true, silent = true, desc = "Diff git close" })
